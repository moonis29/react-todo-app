...
const Navbar = () => {
  return (
    <div>
      <nav className="bg-white border-gray-200 static w-full px-2 sm:px-4 py-2.5 dark:bg-gray-900">
          ...
          >
            ...
            <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="##"
                  className="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-cyan-400 md:p-0 dark:text-white"
                  aria-current="page"
                >
                  Home
                </a>
